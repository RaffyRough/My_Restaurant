...
class KitchenWindow(Client):
    ...
    def __init__(self):
        ...
        self.clear_order = ttk.Button(self.root, text='Close Order')
        self.clear_order.pack()
        self.clear_order.bind('<Button>', self.clearFirstOrder)
    ...
    def clearFirstOrder(self, e):
        self.display.delete('1.0')
